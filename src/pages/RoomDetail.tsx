...
import deluxeDoubleTwin1 from '../Assets/Deluxe double or twin room (7)/1.png';
import deluxeDoubleTwin2 from '../Assets/Deluxe double or twin room (7)/2.png';
import deluxeDoubleTwin3 from '../Assets/Deluxe double or twin room (7)/3.png';
import deluxeDoubleTwin4 from '../Assets/Deluxe double or twin room (7)/4.png';
import deluxeDoubleTwin5 from '../Assets/Deluxe double or twin room (7)/5.png';
import deluxeDoubleTwin6 from '../Assets/Deluxe double or twin room (7)/6.png';
import deluxeDoubleTwin7 from '../Assets/Deluxe double or twin room (7)/7.png';
import deluxeDoubleStandard1 from '../Assets/Deluxe Double Room (5)/1.png';
import deluxeDoubleStandard2 from '../Assets/Deluxe Double Room (5)/2.png';
import deluxeDoubleStandard3 from '../Assets/Deluxe Double Room (5)/3.png';
import deluxeDoubleStandard4 from '../Assets/Deluxe Double Room (5)/4.png';
import deluxeDoubleStandard5 from '../Assets/Deluxe Double Room (5)/5.png';
import deluxeDoubleLarge1 from '../Assets/Deluxe Double Room with shower(6)/1.png';
import deluxeDoubleLarge2 from '../Assets/Deluxe Double Room with shower(6)/2.png';
import deluxeDoubleLarge3 from '../Assets/Deluxe Double Room with shower(6)/3.png';
import deluxeDoubleLarge4 from '../Assets/Deluxe Double Room with shower(6)/4.png';
import deluxeDoubleLarge5 from '../Assets/Deluxe Double Room with shower(6)/5.png';
import deluxeDoubleLarge6 from '../Assets/Deluxe Double Room with shower(6)/6.png';
import budgetDouble1 from '../Assets/Budget Double Room (9)/1.png';
import budgetDouble2 from '../Assets/Budget Double Room (9)/2.png';
import budgetDouble3 from '../Assets/Budget Double Room (9)/3.png';
import budgetDouble4 from '../Assets/Budget Double Room (9)/4.png';
import budgetDouble5 from '../Assets/Budget Double Room (9)/5.png';
import budgetDouble6 from '../Assets/Budget Double Room (9)/6.png';
import budgetDouble7 from '../Assets/Budget Double Room (9)/7.png';
import budgetDouble8 from '../Assets/Budget Double Room (9)/8.png';
import budgetDouble9 from '../Assets/Budget Double Room (9)/9.png';
import deluxeSingle1 from '../Assets/Budget Double Room(6)/1.png';
import deluxeSingle2 from '../Assets/Budget Double Room(6)/2.png';
import deluxeSingle3 from '../Assets/Budget Double Room(6)/3.png';
import deluxeSingle4 from '../Assets/Budget Double Room(6)/4.png';
import deluxeSingle5 from '../Assets/Budget Double Room(6)/5.png';
import deluxeSingle6 from '../Assets/Budget Double Room(6)/6.png';
import deluxeDoubleShower1 from '../Assets/Deluxe Double Room (4)/1.png';
import deluxeDoubleShower2 from '../Assets/Deluxe Double Room (4)/2.png';
import deluxeDoubleShower3 from '../Assets/Deluxe Double Room (4)/3.png';
import deluxeDoubleShower4 from '../Assets/Deluxe Double Room (4)/4.png';
import premiumBudgetDouble1 from '../Assets/Deluxe Double Room (7)/1.png';
import premiumBudgetDouble2 from '../Assets/Deluxe Double Room (7)/2.png';
import premiumBudgetDouble3 from '../Assets/Deluxe Double Room (7)/3.png';
import premiumBudgetDouble4 from '../Assets/Deluxe Double Room (7)/4.png';
import premiumBudgetDouble5 from '../Assets/Deluxe Double Room (7)/5.png';
import premiumBudgetDouble6 from '../Assets/Deluxe Double Room (7)/6.png';
import premiumBudgetDouble7 from '../Assets/Deluxe Double Room (7)/7.png';
