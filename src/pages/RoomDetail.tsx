...
import deluxeDoubleBath1 from '../assets/deluxedoubleroomwithbath (4)/1.png';
import deluxeDoubleBath2 from '../assets/deluxedoubleroomwithbath (4)/2.png';
import deluxeDoubleBath3 from '../assets/deluxedoubleroomwithbath (4)/3.png';
import deluxeDoubleBath4 from '../Assets/deluxedoubleroomwithbath (4)/4.png';
import deluxeDoubleTwin1 from '../assets/deluxedoubleortwinroom (7)/1.png';
import deluxeDoubleTwin2 from '../assets/deluxedoubleortwinroom (7)/2.png';
import deluxeDoubleTwin3 from '../assets/deluxedoubleortwinroom (7)/3.png';
import deluxeDoubleTwin4 from '../assets/deluxedoubleortwinroom (7)/4.png';
import deluxeDoubleTwin5 from '../assets/deluxedoubleortwinroom (7)/5.png';
import deluxeDoubleTwin6 from '../assets/deluxedoubleortwinroom (7)/6.png';
import deluxeDoubleTwin7 from '../assets/deluxedoubleortwinroom (7)/7.png';
import deluxeDoubleStandard1 from '../assets/deluxedoubleroom (5)/1.png';
import deluxeDoubleStandard2 from '../assets/deluxedoubleroom (5)/2.png';
import deluxeDoubleStandard3 from '../assets/deluxedoubleroom (5)/3.png';
import deluxeDoubleStandard4 from '../assets/deluxedoubleroom (5)/4.png';
import deluxeDoubleStandard5 from '../assets/deluxedoubleroom (5)/5.png';
import deluxeDoubleLarge1 from '../assets/deluxedoubleroomwithshower(6)/1.png';
import deluxeDoubleLarge2 from '../assets/deluxedoubleroomwithshower(6)/2.png';
import deluxeDoubleLarge3 from '../assets/deluxedoubleroomwithshower(6)/3.png';
import deluxeDoubleLarge4 from '../assets/deluxedoubleroomwithshower(6)/4.png';
import deluxeDoubleLarge5 from '../assets/deluxedoubleroomwithshower(6)/5.png';
import deluxeDoubleLarge6 from '../assets/deluxedoubleroomwithshower(6)/6.png';
import budgetDouble1 from '../assets/budgetdoubleroom (9)/1.png';
import budgetDouble2 from '../assets/budgetdoubleroom (9)/2.png';
import budgetDouble3 from '../assets/budgetdoubleroom (9)/3.png';
import budgetDouble4 from '../assets/budgetdoubleroom (9)/4.png';
import budgetDouble5 from '../assets/budgetdoubleroom (9)/5.png';
import budgetDouble6 from '../assets/budgetdoubleroom (9)/6.png';
import budgetDouble7 from '../assets/budgetdoubleroom (9)/7.png';
import budgetDouble8 from '../assets/budgetdoubleroom (9)/8.png';
import budgetDouble9 from '../assets/budgetdoubleroom (9)/9.png';
import deluxeSingle1 from '../assets/budgetdoubleroom(6)/1.png';
import deluxeSingle2 from '../assets/budgetdoubleroom(6)/2.png';
import deluxeSingle3 from '../assets/budgetdoubleroom(6)/3.png';
import deluxeSingle4 from '../assets/budgetdoubleroom(6)/4.png';
import deluxeSingle5 from '../assets/budgetdoubleroom(6)/5.png';
import deluxeSingle6 from '../assets/budgetdoubleroom(6)/6.png';
import deluxeDoubleShower1 from '../assets/deluxedoubleroom (4)/1.png';
import deluxeDoubleShower2 from '../assets/deluxedoubleroom (4)/2.png';
import deluxeDoubleShower3 from '../assets/deluxedoubleroom (4)/3.png';
import deluxeDoubleShower4 from '../assets/deluxedoubleroom (4)/4.png';
import premiumBudgetDouble1 from '../assets/deluxedoubleroom (7)/1.png';
import premiumBudgetDouble2 from '../assets/deluxedoubleroom (7)/2.png';
import premiumBudgetDouble3 from '../assets/deluxedoubleroom (7)/3.png';
import premiumBudgetDouble4 from '../assets/deluxedoubleroom (7)/4.png';
import premiumBudgetDouble5 from '../assets/deluxedoubleroom (7)/5.png';
import premiumBudgetDouble6 from '../assets/deluxedoubleroom (7)/6.png';
import premiumBudgetDouble7 from '../assets/deluxedoubleroom (7)/7.png';
